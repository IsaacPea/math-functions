...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    ...
    const str2 = `The product of ${a} and ${b} and ${c} is ${multiply2}.`;
    return [sum2, multiply2, str1, str2];
}
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    const sum3 = sum(numArray[0], numArray[1])[0];
    const sum4 = sum(sum3, numArray[2])[0];
    const str3 = `2,3,4 was passed in as an array of numbers, and ${sum4} is their sum.`;
    return [sum4, str3];
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    const mul3 = multiply(numArray[0], numArray[1])[0];
    const mul4 = multiply(mul3, numArray[2])[0];
    const str4 = `The numbers 2,3,4 have a product of ${mul4}.`;
    return [mul4, str4];
}
